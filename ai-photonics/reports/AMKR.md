...
Amkor is the #2 global OSAT (behind ASE) with 2.5D advanced packaging nearly tripling in 2026, a $7B Arizona campus for US-based advanced AI packaging, and a photonics team focused on SiPh/optical packaging. While less photonics-specific than ASE (which has dedicated SiPh platform and Lightmatter partnership), Amkor's sheer scale and US manufacturing investment make it an important packaging infrastructure play for the AI photonics buildout.

### Key Metrics
| Metric | Value |
|--------|-------|
| Market Position | #2 global OSAT |
| 2.5D Integration | Nearly tripling in 2026 |
| Arizona Campus | $7B investment, US-based |
| Computing Growth (2026) | +20%+ YoY |
